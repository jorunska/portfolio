  ...
  return (
    ...
    <main>
      ...
      <div className="projects">
        <div className="containers pt-5 pb-2">
          <h2 className='pt-5 pb-4'>Siste prosjekt</h2>
          <div className=''>
        <div className='containers'>
          <div className='projects-box'>
            <a href='/prosjekter/happydogs'><h3 className="project-title pb-2 mb-4">Happy Dogs</h3></a>
            <p>Samarbeidet har bestått i utforming av maler til sosiale medier, samt design av ikoner til merkevaren.</p>
          </div>
        </div>
     </div>
     </div>
      ...
      <div className="card card-info flex-md-row align-items-center" id='aboutme'>
